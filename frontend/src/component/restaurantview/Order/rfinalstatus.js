      ...
      <div>
        <div className="container">
          <div className="main-div-menu">
            <div className="panel" />
            <div>
              <h1 className="heading-menu">Delivered/Picked up Orders</h1>
              <div className="container">
                <div>
                    ...
                    <tbody>
                      {this.state.order.map(order => (
                        <tr>
                          ...
                          <td>{order.status}</td>
                          <td><button onClick={this.handlefinalstatus(order.order_id)}>Pickup/Delivery</button></td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
